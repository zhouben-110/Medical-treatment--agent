...
### docker 部署
  ...
  # 方式 A：git clone
  git clone https://github.com/zhouben-110/-------2-.git
  cd 你的项目目录

  # 方式 B：scp 本地传过去
  scp -r ./项目目录 user@虚拟机IP:/home/user/
  ...
  1. 后端用的什么框架？（Flask / FastAPI / Django？）
  2. 有数据库吗？（MySQL / PostgreSQL / SQLite？）
